...
| iamnn-mnist | workflow | 5 | 0.6101 | 0.0302 | 0.6101 | 0.00 | - | 7 |
| skipnet-mnist | workflow | 5 | 0.6080 | 0.0293 | 0.6085 | 0.00 | - | 7 |
| conditional-computation-mnist | workflow | 5 | 0.6011 | 0.0342 | 0.6024 | 0.00 | - | 7 |
...
- `iamnn-mnist`: workflow=iamnn; route_summary={'policy': 'early_exit', 'mode': 'eval', 'gate_mode': 'learned', 'gate_metric': 'margin', 'confidence_threshold': 0.26, 'target_cost_ratio': 0.72, 'target_accept_rate': 0.3, 'early_exit_fraction': 0.0, 'full_path_fraction': 1.0, 'trace_samples': [{'sample': 0, 'path': 'full'}, {'sample': 1, 'path': 'full'}, {'sample': 2, 'path': 'full'}, {'sample': 3, 'path': 'full'}, {'sample': 4, 'path': 'full'}, {'sample': 5, 'path': 'full'}, {'sample': 6, 'path': 'full'}, {'sample': 7, 'path': 'full'}], 'mean_width': 1.0, 'mean_cost_ratio': 1.0}; device=cuda; requested_device=auto; torch=2.11.0+cu128; cuda_available=True; torch_cuda=12.8; cuda_device=NVIDIA GeForce RTX 4070 Laptop GPU
- `skipnet-mnist`: workflow=skipnet; route_summary={'policy': 'early_exit', 'mode': 'eval', 'gate_mode': 'learned', 'gate_metric': 'margin', 'confidence_threshold': 0.28, 'target_cost_ratio': 0.78, 'target_accept_rate': 0.42, 'early_exit_fraction': 0.0, 'full_path_fraction': 1.0, 'trace_samples': [{'sample': 0, 'path': 'full'}, {'sample': 1, 'path': 'full'}, {'sample': 2, 'path': 'full'}, {'sample': 3, 'path': 'full'}, {'sample': 4, 'path': 'full'}, {'sample': 5, 'path': 'full'}, {'sample': 6, 'path': 'full'}, {'sample': 7, 'path': 'full'}], 'mean_width': 1.0, 'mean_cost_ratio': 1.0}; device=cuda; requested_device=auto; torch=2.11.0+cu128; cuda_available=True; torch_cuda=12.8; cuda_device=NVIDIA GeForce RTX 4070 Laptop GPU
- `conditional-computation-mnist`: workflow=conditional_computation; route_summary={'policy': 'early_exit', 'mode': 'eval', 'gate_mode': 'learned', 'gate_metric': 'margin', 'confidence_threshold': 0.44, 'target_cost_ratio': 0.78, 'target_accept_rate': 0.35, 'early_exit_fraction': 0.0, 'full_path_fraction': 1.0, 'trace_samples': [{'sample': 0, 'path': 'full'}, {'sample': 1, 'path': 'full'}, {'sample': 2, 'path': 'full'}, {'sample': 3, 'path': 'full'}, {'sample': 4, 'path': 'full'}, {'sample': 5, 'path': 'full'}, {'sample': 6, 'path': 'full'}, {'sample': 7, 'path': 'full'}], 'mean_width': 1.0, 'mean_cost_ratio': 1.0}; device=cuda; requested_device=auto; torch=2.11.0+cu128; cuda_available=True; torch_cuda=12.8; cuda_device=NVIDIA GeForce RTX 4070 Laptop GPU
...
### iamnn-mnist
- seed 7: final=0.6456, best=0.6456, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 11: final=0.6450, best=0.6450, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 23: final=0.5710, best=0.5710, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 42: final=0.5892, best=0.5892, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 99: final=0.5998, best=0.5998, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000

### skipnet-mnist
- seed 7: final=0.6446, best=0.6446, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 11: final=0.6418, best=0.6418, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 23: final=0.5754, best=0.5754, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 42: final=0.5844, best=0.5870, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 99: final=0.5938, best=0.5938, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000

### conditional-computation-mnist
- seed 7: final=0.6480, best=0.6480, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 11: final=0.6328, best=0.6328, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 23: final=0.5592, best=0.5592, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 42: final=0.5724, best=0.5788, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 99: final=0.5932, best=0.5932, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
...
- iamnn_warmup: epochs=2, range=1..2, adaptation_enabled=False, final_val=0.2858000099658966
- iamnn_routing: epochs=4, range=3..6, adaptation_enabled=False, final_val=0.5902000069618225
- iamnn_consolidation: epochs=2, range=7..8, adaptation_enabled=False, final_val=0.6456000208854675

### skipnet-mnist (best seed 7)
- skipnet_warmup: epochs=3, range=1..3, adaptation_enabled=False, final_val=0.3325999975204468
- skipnet_routing: epochs=5, range=4..8, adaptation_enabled=False, final_val=0.644599974155426

### conditional-computation-mnist (best seed 7)
- conditional_computation_warmup: epochs=2, range=1..2, adaptation_enabled=False, final_val=0.28600001335144043
- conditional_computation_routing: epochs=6, range=3..8, adaptation_enabled=False, final_val=0.6480000019073486
