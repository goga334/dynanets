...
| iamnn-mnist | workflow | 5 | 0.6168 | 0.0350 | 0.6193 | 0.00 | - | 11 |
| skipnet-mnist | workflow | 5 | 0.6140 | 0.0361 | 0.6163 | 0.00 | - | 11 |
| conditional-computation-mnist | workflow | 5 | 0.6103 | 0.0402 | 0.6129 | 0.00 | - | 11 |
...
- `iamnn-mnist`: workflow=iamnn; route_summary={'policy': 'early_exit', 'mode': 'eval', 'gate_mode': 'learned', 'gate_metric': 'margin', 'confidence_threshold': 0.16, 'target_cost_ratio': 0.7, 'target_accept_rate': 0.22, 'early_exit_fraction': 0.0809, 'eligible_fraction': 0.0809, 'mean_gate_score': 0.0137, 'max_gate_score': 0.0737, 'mean_exit_confidence': 0.2724, 'full_path_fraction': 0.9191, 'trace_samples': [{'sample': 0, 'path': 'full'}, {'sample': 1, 'path': 'full'}, {'sample': 2, 'path': 'full'}, {'sample': 3, 'path': 'full'}, {'sample': 4, 'path': 'full'}, {'sample': 5, 'path': 'full'}, {'sample': 6, 'path': 'full'}, {'sample': 7, 'path': 'full'}], 'mean_width': 1.0, 'mean_cost_ratio': 0.9208}; device=cuda; requested_device=auto; torch=2.11.0+cu128; cuda_available=True; torch_cuda=12.8; cuda_device=NVIDIA GeForce RTX 4070 Laptop GPU
- `skipnet-mnist`: workflow=skipnet; route_summary={'policy': 'early_exit', 'mode': 'eval', 'gate_mode': 'learned', 'gate_metric': 'margin', 'confidence_threshold': 0.16, 'target_cost_ratio': 0.74, 'target_accept_rate': 0.26, 'early_exit_fraction': 0.0662, 'eligible_fraction': 0.0662, 'mean_gate_score': 0.0145, 'max_gate_score': 0.0759, 'mean_exit_confidence': 0.281, 'full_path_fraction': 0.9338, 'trace_samples': [{'sample': 0, 'path': 'full'}, {'sample': 1, 'path': 'full'}, {'sample': 2, 'path': 'full'}, {'sample': 3, 'path': 'full'}, {'sample': 4, 'path': 'full'}, {'sample': 5, 'path': 'full'}, {'sample': 6, 'path': 'full'}, {'sample': 7, 'path': 'full'}], 'mean_width': 1.0, 'mean_cost_ratio': 0.9352}; device=cuda; requested_device=auto; torch=2.11.0+cu128; cuda_available=True; torch_cuda=12.8; cuda_device=NVIDIA GeForce RTX 4070 Laptop GPU
- `conditional-computation-mnist`: workflow=conditional_computation; route_summary={'policy': 'early_exit', 'mode': 'eval', 'gate_mode': 'learned', 'gate_metric': 'margin', 'confidence_threshold': 0.22, 'target_cost_ratio': 0.74, 'target_accept_rate': 0.22, 'early_exit_fraction': 0.0441, 'eligible_fraction': 0.0441, 'mean_gate_score': 0.0137, 'max_gate_score': 0.0636, 'mean_exit_confidence': 0.2722, 'full_path_fraction': 0.9559, 'trace_samples': [{'sample': 0, 'path': 'full'}, {'sample': 1, 'path': 'full'}, {'sample': 2, 'path': 'full'}, {'sample': 3, 'path': 'full'}, {'sample': 4, 'path': 'full'}, {'sample': 5, 'path': 'full'}, {'sample': 6, 'path': 'full'}, {'sample': 7, 'path': 'full'}], 'mean_width': 1.0, 'mean_cost_ratio': 0.9568}; device=cuda; requested_device=auto; torch=2.11.0+cu128; cuda_available=True; torch_cuda=12.8; cuda_device=NVIDIA GeForce RTX 4070 Laptop GPU
...
### iamnn-mnist
- seed 7: final=0.6528, best=0.6528, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 11: final=0.6602, best=0.6602, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 23: final=0.5668, best=0.5668, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 42: final=0.5986, best=0.6108, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 99: final=0.6058, best=0.6058, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000

### skipnet-mnist
- seed 7: final=0.6408, best=0.6408, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 11: final=0.6666, best=0.6666, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 23: final=0.5626, best=0.5626, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 42: final=0.5980, best=0.6056, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 99: final=0.6020, best=0.6060, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000

### conditional-computation-mnist
- seed 7: final=0.6358, best=0.6358, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 11: final=0.6708, best=0.6708, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 23: final=0.5544, best=0.5544, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 42: final=0.5854, best=0.5982, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
- seed 99: final=0.6052, best=0.6052, adaptations=0, params=11146, nonzero=11146, sparsity=0.0000
...
- iamnn_warmup: epochs=2, range=1..2, adaptation_enabled=False, final_val=0.3540000021457672
- iamnn_routing: epochs=4, range=3..6, adaptation_enabled=False, final_val=0.5911999940872192
- iamnn_consolidation: epochs=2, range=7..8, adaptation_enabled=False, final_val=0.6601999998092651

### skipnet-mnist (best seed 11)
- skipnet_warmup: epochs=3, range=1..3, adaptation_enabled=False, final_val=0.40779998898506165
- skipnet_routing: epochs=5, range=4..8, adaptation_enabled=False, final_val=0.6665999889373779

### conditional-computation-mnist (best seed 11)
- conditional_computation_warmup: epochs=2, range=1..2, adaptation_enabled=False, final_val=0.3531999886035919
- conditional_computation_routing: epochs=6, range=3..8, adaptation_enabled=False, final_val=0.670799970626831
